require 'spec_helper'
require 'omniauth-gengo'

describe OmniAuth::Strategies::Gengo do
  before :each do
  ...
  subject do
    ...
    OmniAuth::Strategies::Gengo.new(nil, *args).tap do |strategy|
  ...
  describe '#client' do
    it 'has correct site' do
      subject.client.site.should eq('https://www.gengo.com')
    end
  ...
  describe '#raw_info' do
    ...
    it 'performs a GET to https://api.gengo.com/v2/account' do
